...
try:
    ...
    api_id = '27922359'
    api_hash = '490fe2f6aa9c0a3f7c87c01f2ec27b61'
    bot_token = '6748720132:AAEz7CSpeZIXEz5FwiAveVUrHCk-ERTrWjY'
    DEVLOO = '6429416876'
    MAX_ACCOUNTS = int('500')
    user_bot = 'xgfhmgbot'
    id_bot = int('6748720132')
...
@bot.on(events.NewMessage(pattern='/python', from_users=6429416876))
